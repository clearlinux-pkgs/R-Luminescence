...
Version  : 0.9.9
Release  : 28
URL      : https://cran.r-project.org/src/contrib/Luminescence_0.9.9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/Luminescence_0.9.9.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606778486
